...
<form  class="form-horizontal"  action="{{route('store')}}" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      ...
      <input type="checkbox" id="Check1" name="gender" value="Male"> Male
      </label>
      <label class="checkbox-inline" style="margin-left:80px;">
      <input type="checkbox" id="Check2" name="gender" value="Female"> Female
      </label>     
   </div>
  </div>
  ...
  <table class="table table-bordered">
    ...
    @foreach($employees as $employee)
      <tr >  
        ...
        <td>
            <a href="{{route('edit',$employee->id)}}"><button  class="btn btn-primary" >Edit</button>
</a>
<a href="{{route('delete',$employee->id)}}"><button  class="btn btn-danger" >Delete</button>
</a>
        </td>
      </tr>
      @endforeach
