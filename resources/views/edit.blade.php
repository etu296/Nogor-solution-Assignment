...
<form  class="form-horizontal"  action="" method="post" enctype="multipart/form-data">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" value="{{$employees->name}}" required class="form-control" id="name" placeholder="Enter name" name="name">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="email" value="{{$employees->email}}" required  class="form-control" id="email" placeholder="Enter email" name="email">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-5">
      <input  value="{{$employees->image}}" required  class="form-control" id="image"  >
      <br>
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="id[]" value="{{$employees->id}}">
                                                <td>
                                                        <input type="checkbox" name="gender[{{$employees->id}}]" value="Male" 
                                                        <?php 
                                                        ...
                                                        ?>> Male
                                                        <input type="checkbox" name="gender[{{$employees->id}}]" value="Female" 
                                                        <?php 
    ...
    <div class="col-sm-5">
     <div class="checkbox">
      <label class="checkbox-inline">
       <input type="checkbox" name="skill[]" id="Check1" value="Laravel"> Laravel
      </label>
      <label class="checkbox-inline" style="margin-left:80px;">
        <input type="checkbox" name="skill[]" id="Check2" value="Codeigniter"> Codeigniter
      </label>
      </div>

     <div class="checkbox">
      <label class="checkbox-inline">
       <input type="checkbox" name="skill[]" id="Check1" value="Ajax"> Ajax
      </label>
      <label class="checkbox-inline" style="margin-left:80px;">
        <input type="checkbox" name="skill[]" id="Check2" value="VUE JS"> VUE JS
      </label>
      </div>

      <div class="checkbox">
      <label class="checkbox-inline" >
       <input type="checkbox" name="skill[]" id="Check1" value="MySql"> MySql
      </label>
      
      <label class="checkbox-inline" style="margin-left:80px;">
        <input type="checkbox" name="skill[]" id="Check2" value="API"> API
      </label>
      </div>
  ...
  <div class="form-group">        
    ...
    <div class="text-right">
      <button type="submit" style="padding: 7px 35px;" class="btn btn-default">Update</button>
    </div>
    </div>
  </div>
</form>
